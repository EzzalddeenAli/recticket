...
// if there is already a ticket opened or pending from that contact, update that
// updates ticket if the last closed ticket for the contact is less than 2 hours back
// creates new ticket otherwise
